...
class CNN(nn.Module):
    ...
    def __init__(self, image_channels, image_height, image_width, output_size):
        super(CNN, self).__init__()
        self.conv1 = nn.Conv2d(image_channels, 6, kernel_size=5, stride=2, padding=2)
        self.conv2 = nn.Conv2d(6, 16, kernel_size=5, stride=2, padding=2)
        self.num_flat_features = 16 * image_height // 4 * image_width // 4
        self.fc1 = nn.Linear(self.num_flat_features, 1000)
...
class MLP(nn.Module):
    ...
    def __init__(self, image_channels, image_height, image_width, output_size):
        ...
        self.num_flat_features = image_channels * image_height * image_width
